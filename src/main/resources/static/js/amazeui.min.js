		...
		o.removeSession = function(t) {
			...
			if (this.doLog = o.doLog, this.options = s({}, o.defaults), s(this.options, t), this.options.debug && (this.options.logging = !0), l) {
				...
				if (this.options.detectHomescreen) {
					if (o.hasToken) return a(), this.session.added || (this.session.added = !0, this.updateSession(), this.options.onAdd && o.hasLocalStorage && this.options.onAdd.call(this)), void this.doLog("Add to homescreen: not displaying callout because URL has token, so we are likely coming form homescreen");
