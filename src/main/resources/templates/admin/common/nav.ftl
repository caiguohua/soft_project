<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar-nav">
        ...
        <li>
            <a href="/soft/clubInfo/list"><i class="fa fa-fw fa-list-alt"></i> 会所管理</a>
        </li>
        ...
        <li class="dropdown open">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-fw fa-plus"></i> 标签 <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="/soft/clubLabel/list">列表</a></li>
                <li><a href="/soft/clubLabel/list">新增</a></li>
            </ul>
        </li>
