        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <form role="form" method="post" action="/soft/clubProduct/update">
                        <div class="form-group">
                            <label>会所id</label>
                            <input name="cid" type="text" class="form-control" value="${(clubProduct.cid)!''}"/>
                        </div>
                        <div class="form-group">
                            <label>名字</label>
                        ...
                        <input hidden type="number" name="id" value="${(clubProduct.id)!''}">
