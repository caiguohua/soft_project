            ...
            <ol>
                <table border>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="order?uid=${uid}&pid=${clubProduct.id}&cid=${clubInfo.id}">
        ...
        <div class="sppj hide">
            ...
            <table border>
                ...
                <#list commentList as comments>
                    <tr>
                        <td><li><font size="4" color="black">${comments.comment}</font></li></td>
                    </tr>
                </#list>
                </tbody>
            </table>
            ...
            <span class="tag">您最多可以输入30个字符</span>

            <form role="form" method="post" action="/soft/user/comment">
                <div class="form-group">
                    <input name="comment" type="text" class="form-control" value="${(comment)!''}"/>
                    <input hidden type="number" name="cid" value="${(clubInfo.id)!''}">
                    <input hidden type="number" name="uid" value="${(uid)!''}">
                </div>
                    <#--<textarea id="text" cols="30" rows="10" maxlength="30" class="text"></textarea><br>-->
                    <#--<input type="button" value="发 表" id="ipt" value="${(clubComment.comment)!''}">-->
                <button type="submit" class="btn btn-default btn-success">发表</button>
            </form>
            <div id="txt" >
            </div>
        </div>
