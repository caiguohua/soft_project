...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="/soft/static/css/login.css" />
		<link rel="stylesheet" href="/soft/static/css/mui.min.css" />
		<script type="text/javascript" src="/soft/static/js/mui.min.js" ></script>
		<script type="text/javascript" src="/soft/static/js/login.js" ></script>
		<title>会所登陆页</title>
		<style>
			.bottomLine{
...
<!--			</div>-->
			<div style="float: right;margin-right: 60px;margin-top: 18px;">
				<span style="float: right;font-size: 12px;margin-left: 5px;color: #7d7d7d;"><span style="background-image: url(/soft/static/img/massageicon.png);width: 20px;height: 20px;margin-top:4px;float: left;background-repeat: no-repeat;margin-right: 8px;"></span>对登录页面的建议</span>
			</div>
			</div>
		</div>
		<div class="am-g content"  style="margin-top: 43px;">
			...
			<div style="width:1200px;margin:0 auto;position: relative;z-index: 999;">
				<div class="loginDiv " style="display: block;"  id="login" >
						...
						<img src="/soft/static/img/erweima.png" style="float: right;height: 58px;" id="loginimg">
						</div>
...
<!--				    <p style="text-align: center;"><span style="background-image: url(/soft/static/img/Download-512.png);float: left;width: 20px;height: 20px;margin-top:5px;background-repeat: no-repeat;margin-left: 100px;"></span>-->
